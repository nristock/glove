...
class VertexData : public GloveObject {
	GLOVE_MEM_ALLOC_FUNCS("VertexData")
public:
	...
	virtual size_t GetBufferCount() const { return bufferBindingMap.size(); }
	/** Returns the internal buffer binding map */
	virtual const VertexBufferBindingMap& GetBindings() const { return bufferBindingMap; }
	...
	virtual VertexLayout* GetVertexLayout() { return &vertexLayout; }

	/** Returns the number of vertices */
	virtual size_t GetVertexCount() const { return vertexCount; }
