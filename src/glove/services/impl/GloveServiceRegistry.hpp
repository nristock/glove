...
/// Services can signal the registry whether their initialization was successful or not. See \link glove::Service. The
...
class GLOVE_API_EXPORT GloveServiceRegistry : public ServiceRegistry {
  public:
    GloveServiceRegistry();
    GloveServiceRegistry(bool deferServiceInitialization);
